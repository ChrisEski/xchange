...
export const deleteArticle = async (postId, postCategory, username) => {
  console.log("Deleting post:", postId);
  console.log("Deleting post category:", postCategory);
  // try {
  //   const response = await fetch(`${baseURL}/api/posts/${postCategory}/${postId}`, {
  //     method: "DELETE",
  //     headers: {
  //       "Content-Type": "application/json",
  //     },
