 ...
 * @param {string} username - The username of the author whose posts are being fetched.
...
/**
 * Fetches posts by category from the server.
 *
 * @param {string} category - The category of posts to fetch.
 * @returns {Promise<object[]>} The array of posts belonging to the specified category.
